...
module.exports = {
  ...
  SESSION_ID: (process.env.SESSION_ID || 'Mrfg4SL2Sn').trim(),
  DATABASE:
  ...
  BRANCH: 'master',
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || '🤍,sl',
  ...
  MAX_UPLOAD: process.env.MAX_UPLOAD || 2000,
  ...
  DELETE_TYPE: (process.env.DELETE_TYPE || 'off').trim(),
